...
export const Property1Support = ({ className }) => {
  return (
    <svg
      className={`property-1-support ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <path
        ...
        strokeWidth="2"
      />
      <path className="path" d="M12 22V8" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path
        className="path"
