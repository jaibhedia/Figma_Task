...
export const Property1SignOut = ({ className }) => {
  return (
    <svg
      className={`property-1-sign-out ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <path
        ...
        strokeWidth="2"
      />
      <path className="path" d="M12 2V12" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
    </svg>
  );
};
